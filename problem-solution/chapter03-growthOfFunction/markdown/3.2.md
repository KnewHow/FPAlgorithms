...
*  A
![](http://latex.codecogs.com/gif.latex?\because n! = \sqrt{2\pi n}\left ( \frac{n}{e} \right )^{n}e^{\alpha _{n}} \\ \therefore lg(n!) = nlg\left (\sqrt{2\pi n} \cdot \frac{n}{e} \cdot e^{\alpha_{n}}  \right) = nlg\left ( \Theta \left ( n \right ) \right ) = \Theta (nlgn))
